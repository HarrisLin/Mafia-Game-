...
/**
 * GameEngine
 * The game engine is responsible for keeping track of everything that happens
 * in the game. This will include:
...
public class GameEngine {
	 ...
	 * @param player The human name of the player
	...
	/**
	 * GameEngine.assignCharacters
	 * Randomly assigns a character role to all players
	 */
	...
	/**
	 * GameEngine.assignCharacter
	 * Assigns a single character role to a single player
	 */
	...
	/**
	 * GameEngine.performNightActions
	 * Makes each character perform his/her night action
	 */
